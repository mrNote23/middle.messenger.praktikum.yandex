...
export const rightRoutes: TSwitchRoute[] = [
  {
    path: RIGHTMODE.CHAT,
    content: `<chat-header class="chat-header"></chat-header><chat-body class="chat-body"></chat-body><chat-footer class="chat-footer"></chat-footer>`,
  },
  {
